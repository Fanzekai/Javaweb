...
<div style="padding: 10px" class="admin-content">
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei4" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_fenlei4").val($(".class_fenlei4").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        商品名称
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_quyu5 select-update").val($(".class_quyu5 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        是否推荐
                        ...
                        <select
                            class="form-control class_shifoutuijian6"
                        ...
                        <script>
                            $(".class_shifoutuijian6").val($(".class_shifoutuijian6").attr("data-value"));
                        </script>
                    </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapfenlei3 = new CommDAO().find("SELECT fenleiming,id FROM fenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapfenlei3.get("fenleiming") %></td>
...
-<%} else { %><img width="100" src="<%= Info.images(map.get("tupian")) %>" /><%} %>
                            ...
                            <td><% Map mapquyu4 = new CommDAO().find("SELECT quyuming,id FROM quyu where id='" + map.get("quyu") + "'"); %>
<%= mapquyu4.get("quyuming") %></td>
