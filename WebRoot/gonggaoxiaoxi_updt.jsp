...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmap(request.getParameter("id"), "gonggaoxiaoxi");
     %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑公告消息:</div>
            <div class="panel-body">
                <form action="gonggaoxiaoxi.jsp?a=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=gonggaoxiaoxi&col=biaoti"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="neirong" name="neirong" style="max-width: 750px; width: 100%; height: 300px"><%= Info.html(mmm.get("neirong")) %></textarea>
                                <script>
                                    (function () {
