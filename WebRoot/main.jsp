...
-->
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">欢迎登录农贸市场管理系统的设计与实现，<%= request.getSession().getAttribute("username") != null ? request.getSession().getAttribute("username") : "" %>
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            ...
            <%} %>
            <% if ("农户".equals(request.getSession().getAttribute("cx"))) { %>
            <%@ include file="left_nonghu.jsp" %>
            <%} %>
