                ...
                <form action="yonghu.jsp?a=update" method="post" name="form1" id="form1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    type="text"
                                    class="form-control"
                                    placeholder="<span class='error-message'>输入用户名</span>"
                                    style="width: 150px"
                                    data-rule-required="true"
                                    data-msg-required="<span class='error-message'>请填写用户名</span>"
                                    remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=yonghu&col=yonghuming"
                                    data-msg-remote="<span class='error-message'>内容重复了</span>"
                                    id="yonghuming"
                                    name="yonghuming"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_xingbie19" data-value="<%= Info.html(mmm.get("xingbie")) %>" id="xingbie" name="xingbie" style="width: 250px">
