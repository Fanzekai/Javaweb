...
<div style="padding: 10px" class="admin-content">
    ...
    %> <%
    HashMap mmm = new CommDAO().getmaps("zhanghao", (String) request.getSession().getAttribute("username"), "nonghu");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入姓名" style="width: 150px"
                                       id="xingming" name="xingming" value="<%= Info.html(mmm.get("xingming")) %>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_xingbie4"
                                        data-value="<%= Info.html(mmm.get("xingbie")) %>" id="xingbie" name="xingbie"
                                        style="width: 250px">
...
<%--                            <div class="col-sm-10">--%>
<%--                                <select class="form-control class_suozaitanwei5"--%>
<%--                                        data-value="<%= Info.html(mmm.get("suozaitanwei")) %>" id="suozaitanwei"--%>
<%--                                        name="suozaitanwei" style="width: 250px">--%>
...
<%--                                </select>--%>
<%--                                <script>--%>
<%--                                    $(".class_suozaitanwei5").val($(".class_suozaitanwei5").attr("data-value"));--%>
<%--                                </script>--%>
<%--                            </div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input type="text" class="form-control" id="yingyezhizhao" name="yingyezhizhao"
                                           value="<%= Info.html(mmm.get("yingyezhizhao")) %>"/>
