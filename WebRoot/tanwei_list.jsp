...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 摊位 </span>
            <span>列表</span>
        </div>
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_quyu22" data-value="<%= request.getParameter("quyu") !=null ? request.getParameter("quyu") : "" %>" id="quyu" name="quyu">
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_quyu22").val($(".class_quyu22").attr("data-value"));
                        </script>
                    </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapquyu29 = new CommDAO().find("SELECT quyuming,id FROM quyu where id='" + map.get("quyu") + "'"); %>
<%= mapquyu29.get("quyuming") %></td>
...
-<%} else { %><img width="100" src="<%= map.get("tupian") %>" /><%} %>
                            ...
                            <td align="center">
                                <a href="tanwei_detail.jsp?id=<%= map.get("id") %>">详情</a>

                                <a href="tanwei_updt.jsp?id=<%= map.get("id") %>">编辑</a>

                                <a href="tanwei.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
