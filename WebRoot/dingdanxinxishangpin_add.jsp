...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加订单信息商品:</div>
            <div class="panel-body">
                <form action="dingdanxinxishangpin.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入商品编号" style="width: 150px" id="shangpinbianhao" name="shangpinbianhao" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_fenlei38" data-value="" id="fenlei" name="fenlei" style="width: 250px">
