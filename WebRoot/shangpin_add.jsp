...
<div style="padding: 10px" class="admin-content">
 ...
 <% for (Map m : select) { %>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="xiangqing" name="xiangqing" style="max-width: 750px; width: 100%; height: 300px"></textarea>
                                <script>
                                    (function () {
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">摊位<span style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    ...
                                    <select class="form-control class_quyu_search8" data-value="" id="quyu_search" name="quyu_search">
 ...
 <% for (Map m : select) { %>
                                    ...
                                    <button type="button" class="btn btn-default" onclick="tanwei_select_update()">搜索</button>
                                    <script>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control select-update" placeholder="输入摊位号" style="width: 150px" id="tanweihao" name="tanweihao" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select-update" data-value="" id="quyu" name="quyu" style="width: 250px">
                                    <% select = new CommDAO().select("SELECT * FROM quyu ORDER BY id desc"); %>
 <% for (Map m : select) { %>
