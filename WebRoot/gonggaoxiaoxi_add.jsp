...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加公告消息:</div>
            <div class="panel-body">
                <form action="gonggaoxiaoxi.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="factory/checkno.jsp?checktype=insert&table=gonggaoxiaoxi&col=biaoti"
