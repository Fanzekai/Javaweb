            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_dingdanzhuangtai2" data-value="<%= request.getParameter("dingdanzhuangtai") !=null ? request.getParameter("dingdanzhuangtai") : "" %>" id="dingdanzhuangtai" name="dingdanzhuangtai">
                            <option value="">请选择</option>
                            <option value="待支付">待支付</option>
                            <option value="已支付">已支付</option>
                        </select>
                        <script>
                            $(".class_dingdanzhuangtai2").val($(".class_dingdanzhuangtai2").attr("data-value"));
                        </script>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                ...
                                <% if (map.get("dingdanzhuangtai").equals("待支付")) { %>
