                ...
                <form action="shangpin.jsp?a=update" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_fenlei10"
                                        data-value="<%= Info.html(mmm.get("fenlei")) %>" id="fenlei" name="fenlei"
                                        style="width: 250px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="xiangqing" name="xiangqing"
                                          style="max-width: 750px; width: 100%; height: 300px"><%= Info.html(mmm.get("xiangqing")) %></textarea>
                                <script>
                                    (function () {
                            ...
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    <select
                                            ...
                                            data-value="<%= Info.html(mmm.get("tanwei")) %>"
                                            data-rule-required="true"
                                    ...
                                    <select class="form-control class_quyu_search11" data-value="" id="quyu_search"
                                            name="quyu_search">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select-update"
                                        data-value="<%= Info.html(mmm.get("quyu")) %>" id="quyu" name="quyu"
                                        style="width: 250px">
                                    <% select = new CommDAO().select("SELECT * FROM quyu ORDER BY id desc"); %>
                                    <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_quyu12 select-update").val($(".class_quyu12 select-update").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">是否推荐</label>
                            <div class="col-sm-10">
                                <div class="class_shifoutuijian13"
                                     data-value="<%= Info.html(mmm.get("shifoutuijian")) %>">
                                    <label
                                    ><input type="radio"
                                            id="shifoutuijian" name="shifoutuijian" value="是"/>
                                        是</label
                                    >
                                    <label
                                    ><input type="radio"
                                            id="shifoutuijian" name="shifoutuijian" value="否"/>
                                        否</label
                                    >
                                </div>
                                <script>
                                    $(".class_shifoutuijian13 :radio[value='<%= Info.html(mmm.get("shifoutuijian")) %>']").prop("checked", true);
                                </script>
                            </div>
                        </div>
                    </div>
