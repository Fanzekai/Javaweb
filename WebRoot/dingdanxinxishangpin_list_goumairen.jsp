...
<div style="padding: 10px" class="admin-content">
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_dingdanxinxiid35" data-value="<%= request.getParameter("dingdanxinxiid") !=null ? request.getParameter("dingdanxinxiid") : "" %>" id="dingdanxinxiid" name="dingdanxinxiid">
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_dingdanxinxiid35").val($(".class_dingdanxinxiid35").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        商品id

                        <select class="form-control class_shangpinid36" data-value="<%= request.getParameter("shangpinid") !=null ? request.getParameter("shangpinid") : "" %>" id="shangpinid" name="shangpinid">
                            <option value="">请选择</option>
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_shangpinid36").val($(".class_shangpinid36").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        商品编号
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei37" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
                            <option value="">请选择</option>
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_fenlei37").val($(".class_fenlei37").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        商品名称
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapfenlei42 = new CommDAO().find("SELECT fenleiming,id FROM fenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapfenlei42.get("fenleiming") %></td>
