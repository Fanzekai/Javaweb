            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <select class="form-control class_dingdanxinxiid29"
                        ...
                        <script>
                            $(".class_dingdanxinxiid29").val($(".class_dingdanxinxiid29").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group" style="display: none">
                        商品id

                        <select class="form-control class_shangpinid30"
                        ...
                        <script>
                            $(".class_shangpinid30").val($(".class_shangpinid30").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        商品编号
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei31"
                        ...
                        <script>
                            $(".class_fenlei31").val($(".class_fenlei31").attr("data-value"));
                        </script>
                    </div>
            ...
            <div class="list-table">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            Map mapfenlei36 = new CommDAO().find("SELECT fenleiming,id FROM fenlei where id='" + map.get("fenlei") + "'"); %>
                            <%= mapfenlei36.get("fenleiming") %>
                        </td>
...
<%--                            <a href="dingdanxinxishangpin_updt.jsp?id=<%= map.get("id") %>">编辑</a>--%>

                            <a href="dingdanxinxishangpin.jsp?a=delete&id=<%= map.get("id") %>"
