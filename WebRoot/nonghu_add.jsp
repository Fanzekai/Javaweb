...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加农户:</div>
            <div class="panel-body">
                <form action="nonghu.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="factory/checkno.jsp?checktype=insert&table=nonghu&col=zhanghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_suozaitanwei3" data-value="" id="suozaitanwei" name="suozaitanwei" style="width: 250px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input type="text" class="form-control" id="yingyezhizhao" name="yingyezhizhao" value="" />
