    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ac.equals("login")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                if (utype.equals("农户")) {
                    sql1 = "select * from nonghu where zhanghao='" + username + "' and mima='" + password + "' ";
                }
        ...
        if (ac.equals("adminuppass")) {
            ...
            if (cx.equals("农户")) {
                ...
                // dao.getmaps("zhanghao", (String) request.getSession().getAttribute("username"), "nonghu");
            }
            ...
            if (m == null || m.isEmpty()) {
                ...
                if (cx.equals("农户")) {
                    sql = "UPDATE nonghu SET mima='" + userpass + "' WHERE zhanghao='" + username + "'";
                }
